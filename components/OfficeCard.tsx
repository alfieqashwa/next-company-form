        ...
        <Modal isOpen={isOpen} onClose={onClose}>
          <div className='w-full space-y-10'>
            ...
            <div className='flex items-center justify-between px-14'>
              <button
                className='px-4 py-2 text-sm text-white transition duration-300 ease-in-out bg-red-500 rounded-md focus:ring-offset-1 focus:ring-2 hover:opacity-75 focus:opacity-100 focus:ring-opacity-75 focus:ring-red-500 focus:outline-none'
                type='button'
                onClick={onClose}>
                Cancel
              </button>
              <button
                className='px-4 py-2 text-sm text-white duration-300 ease-in-out bg-green-600 rounded-md transtion hover:opacity-75 focus:ring-offset-1 focus:ring-2 focus:ring-opacity-75 focus:opacity-100 focus:ring-green-600 focus:outline-none'
                type='button'
                onClick={remove}>
                {isLoading ? (
